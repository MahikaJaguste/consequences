          ...
          return enabled ? (
            ...
            ${gameAccountAddress} (`}
              <a
                ...
                href={`https://${process.env.NEXT_PUBLIC_FLOW_NETWORK_EMULATOR}.flowview.app/account/${gameAccountAddress}/fungible_token`}
                target="_blank"
                rel="noreferrer"
              >
      ...
      <Modal
        ...
        DialogContent={() => (
          <div>
            ...
            <a
              className="text-blue-600"
              href={`https://${process.env.NEXT_PUBLIC_FLOW_NETWORK_EMULATOR}.flowview.app/account/${gameAccountAddress}`}
              target="_blank"
              rel="noreferrer"
            >
              {'View account on flowview'}
